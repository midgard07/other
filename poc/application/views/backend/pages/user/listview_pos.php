		...
		<div class="container">
			...
			<div class="table-responsive">
				<table class="table table-striped table-condensed">
					<thead>
						<tr>
							<th><?php echo gridHeader('u.username', 'Username', $cfg) ?></th>
							<th><?php echo gridHeader('u.outlet', 'Nama Lengkap', $cfg) ?></th>
						</tr>
					</thead>
					<tbody>
						<?php
						...
						<tr>
							...
							<td>
								<a href="<?php echo site_url('user/view/'.$row->USERNAME.'/'.$grid_state) ?>" class="edit_link">Lihat / Edit</a>
							</td>
						</tr>
						<?php
							}

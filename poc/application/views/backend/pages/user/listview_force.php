		...
		<div class="container">
			...
			<div class="table-responsive">
				<table class="table table-striped table-condensed">
					<thead>
						<tr>
							<th><?php echo gridHeader('u.user_name', 'Username', $cfg) ?></th>
							<th><?php echo gridHeader('u.real_name', 'Nama Lengkap', $cfg) ?></th>
						</tr>
					</thead>
					<tbody>
						<?php
						...
						<tr>
							...
							<td>
								<a href="<?php echo site_url('user/view/'.$row->USER_ID.'/'.$grid_state) ?>" class="edit_link">Lihat / Edit</a>
							</td>
						</tr>
						<?php
							}
